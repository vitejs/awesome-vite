...
- [vite-electron-builder](https://github.com/cawa-93/vite-electron-builder/) - GitHub template for Electron apps. Using Vite for frontand and backend and electron-builder with auto updates.
