...
- [electron-vite-boilerplate](https://github.com/caoxiemeihao/electron-vite-boilerplate) - Full featured Electron + Vite boilerplate. Support SQLite3, Serialport and other node-native addons.
