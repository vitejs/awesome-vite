...
- [vite-vue2-js-template-starter](https://github.com/ElanYoung/vite-vue2-js-template-starter) - Vite + Vue2 + JavaScript + Vue Router + Vuex + Axios + Less + ESLint + Stylelint + Prettier Simple Template.
