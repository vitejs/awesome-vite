...
- [RVTGB](https://github.com/up2dul/rvtgb) - ⚛️ A minimal React + Vite + TypeScript starter template, with 📁 file-based routing with `Generouted`, and `Biome` as the code 📝 linter + formatter.
