...
- [
vite-plugin-require-transform](https://github.com/WarrenJones/vite-plugin-require-transform) - A vite plugin that converts the code from require syntax to import that compact esm.
