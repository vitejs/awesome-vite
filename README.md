...
- [vite-react-ssr](https://github.com/jquery-dlya-slabih/ssr) - Server side rendering template with `TypeScript`, `React 19`, `React Router`, `React Query`, `Valibot`, `Tailwind`, `Testing Library`, `Playwright`.
- [vite-react-csr](https://github.com/jquery-dlya-slabih/csr) - Client side rendering template with `TypeScript`, `React 19`, `TanStack Router`, `React Query`, `Valibot`, `Tailwind`, `Testing Library`, `Playwright`.
