...
- [Havoptic](https://github.com/scotthavird/havoptic.com) - Release tracker for AI coding tools aggregating changelogs from Cursor, Codex CLI, Claude Code and more.
