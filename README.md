...
- ![v3] [vite-plugin-vue-tailwind-auto-reference](https://github.com/M1CK431/vite-plugin-vue-tailwind-auto-reference) - Automatically `@reference` your Tailwind CSS file in Vue SFC `<style>` blocks
