...
- [create-nx-workspace](https://nx.dev/packages/vite#setting-up-a-new-nx-workspace-with-vite) - Scaffolding a Nx + React + Vite + Vitest.
...
- [CRA to Nx + Vite tool](https://nx.dev/recipes/adopting-nx/migration-cra) - An automated tool to convert a Create React App project to use Nx + Vite + Vitest.
