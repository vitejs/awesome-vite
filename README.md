...
- [automatic-workspace-folders-vanilla](https://github.com/bmeurer/automatic-workspace-folders-vanilla) - Automatically serve a `.well-known/appspecific/com.chrome.devtools.json` file to Chrome DevTools
