...
- [vite-plugin-twig-builder](https://github.com/Wyndace/vite-plugin-twig-builder) - Lightweight plugin for generating static HTML from Twig templates with nested directory support and flexible configuration.
