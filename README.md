...
- [ovx](https://github.com/ovx-js) - Starter template with TypeScript, Vue-Router4, ESLint, Ant Design / Element Plus, TSX support, Unplugin auto imports. Chinese docs.
