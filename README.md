...
- [vite-plugin-version-injection](https://github.com/tinywaves/vite-plugin-version-injection) - A vite plugin that injects version information into your vite based application.
