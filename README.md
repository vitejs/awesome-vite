...
- [vite-plugin-html-rewrite](https://github.com/donnikitos/vite-plugin-html-rewrite) - A plugin to programmatically rewrite HTML tags, allowing custom changes to content, attributes, and structure.
