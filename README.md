...
- [electron-vue-next](https://github.com/ci010/electron-vue-next) - Starter template using Vue 3 in Vite 2 and latest Electron with fluent VS Code debug and GitHub release process out-of-box.
