...
- [PHP-Vite Starter Repo](https://github.com/nititech/php-vite-starter) - A PHP-Vite starter repository, with TypeScript/JavaScript, Tailwind CSS, SASS/SCSS, EJS, SVG and image support.
