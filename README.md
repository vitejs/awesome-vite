...
- [vite-react-powersync-supabase](https://github.com/powersync-community/vite-react-ts-powersync-supabase) - A templated `Vite`, `React`, `PowerSync` and `Supabase` project to get you started quickly with building offline-first applications with `PowerSync` and `Supabase`.
