...
- [vite-plugin-sri-gen](https://github.com/rbonestell/vite-plugin-sri-gen) - Adds calculated SRI integrity attribute to script, style, and appropriate link elements in HTML outputs at build time for SPA, MPA, and prerendered SSR/SSG HTML projects.
