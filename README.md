...
- [vite-plugin-llms](https://github.com/yourusername/vite-plugin-llms) - Integration for the llms.txt specification supporting AI optimized content alongside application routes
