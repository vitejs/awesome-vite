...
- [vite-plugin-component-placeholder](https://github.com/chouchouji/vite-plugin-component-placeholder) - A vite plugin to generate componentPlaceholder config for miniprogram.
