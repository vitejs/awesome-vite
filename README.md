...
- [stravital](https://github.com/rizkimcitra/stravital) - Minimalist starter template for universal project, including TypeScript, Git Hooks, Commitizen, Lint Staged, and TailwindCSS for styling.
