...
- [@ndriadev/vite-plugin-universal-api](https://github.com/nDriaDev/vite-plugin-universal-api) - Comprehensive mock server with WebSocket, REST, and file-based API support.
