...
- [@import-meta-env/vite](https://github.com/iendeavor/import-meta-env) - Inject environment variables into the `import.meta.env` object **after building the application** instead of statically replacing it during production.
