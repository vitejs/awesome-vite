...
- [vite-plugin-capo](https://github.com/hsimpson270/vite-plugin-capo) - Reorders HTML `<head>` elements at build time using capo.js guidelines to improve page load performance.
