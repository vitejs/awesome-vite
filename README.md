...
- [vite-plugin-setting-css-module](https://github.com/ProgrameBoy/vite-plugin-setting-css-module) - Implementing CSS-Modules with vite modularity rules, you can specify css modularity using RegExp or Function. Don't need create `xxx.module.css`.
