...
- [boot-vue](https://github.com/kirklin/boot-vue) - Boot Vue is a lightning fast Vue 3 boilerplate with strongly typed TypeScript, UnoCSS, DaisyUI, Vue Router, Pinia.
