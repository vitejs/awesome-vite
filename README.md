...
- [vite-vue-lib-template](https://github.com/ehsan-shv/vite-vue-lib-template) - Vite Vue 3 lib template: Vue 3, Eslint, Prettier, Conventional Commit, Pre-commit, Lint-staged, Semantic-release, TypeScript.
