...
- [vulcan](https://github.com/pengzhanbo/vulcan) - The template for mobile application. Vite, Vue3, Typescript, Sass, i18n, Vitest&Cypress, Pinia,  APIs&Mock, ESlint, Prettier, auto-importing.
