...
- [devextreme-vue-template](https://github.com/DevExpress/devextreme-vue-template) - Starter template with `Vite` + `Vue3` + `Vue Router` + `DevExtreme UI Components`.
...
- [devextreme-react-template](https://github.com/DevExpress/devextreme-react-template) - Starter template with `Vite` + `React` + `React Router` + `DevExtreme UI Components`.
