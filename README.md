...
- [vite-plugin-merge-css](https://github.com/doberkofler/vite-plugin-merge-css) - Automatically merges all css chunks for each entry point into a single css file.
