...
- [vite-plugin-preload](https://github.com/jarlef/vite-plugin-preload) - Preload all chunks and stylesheets when dealing with code splitting through frameworks (e.g React.lazy) instead of manualChunks.
#### Loaders
