...
- [chrome-extension-boilerplate-react-vite](https://github.com/Jonghakseo/chrome-extension-boilerplate-react-vite) - React + Typescript + SASS + Prettier + Eslint + ChromeExtension Template (Manifest v3)
