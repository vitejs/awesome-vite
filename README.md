...
- [react-jsx-spa-starter](https://github.com/SakshhamTheCoder/react-jsx-spa-starter) - A minimal SPA starter template using `React`, `TailwindCSS`, `React-Router`, and `Axios` in `JavaScript`
