...
- [@baleada/vite-serve-as-vue](https://baleada.netlify.app/docs/vite-serve-as-vue) - A middleware for Vite's development server that can serve any file (e.g. `.md` or `.svg`) as a Vue component, watch that file for changes, and hot reload the corresponding Vue component when a change is detected.
