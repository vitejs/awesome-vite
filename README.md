...
- [vite-plugin-html-env](https://github.com/lxs24sxl/vite-plugin-html-env) - Injection of environment variables in `index.html`, support for template directives (`vite-if`、`vite-else`) and binding rules(`<{**}>`、`import.meta.env.**`)
