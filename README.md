...
- [vite-plugin-dynamic-require-import](https://github.com/yangyanhui1217/vite-plugins-related/tree/main/packages/dynamicRequireImport) - Supports `component: resolve => require(["../views/index"], resolve)`
