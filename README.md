...
- [vite-plugin-devtools-json](https://github.com/ChromeDevTools/vite-plugin-devtools-json) - Automatically serve a `.well-known/appspecific/com.chrome.devtools.json` file to Chrome DevTools.
