...
- [vue-admin-box](https://github.com/cmdparkour/vue-admin-box) - A backend admin box based on vue3 + vite + element-plus, a good project that help people easy to develop crud.
