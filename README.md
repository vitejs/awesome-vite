...
- ![v3] [vite-plugin-vue-setup-inherit-attrs](https://github.com/kalimah-apps/vite-plugin-vue-setup-inherit-attrs) - Extend vue script setup syntactic sugar to support inherit-attrs
