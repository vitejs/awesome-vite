...
- [vite-plugin-view](https://github.com/fengxinming/vite-plugins/tree/main/packages/vite-plugin-view) - Dynamically render pages using custom template engines instead of the static `.html` entry file.
