...
- [vite-plugin-importus](https://github.com/Geocld/vite-plugin-importus) - The faster modularly import plugin for Vite, just like `babel-plugin-import` but has higher performance.
