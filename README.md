...
- [vite-plugin-api](https://github.com/yracnet/vite-plugin-api) - Generate route mapping for API Routes services from the directory tree, like to [NextJS API Routes](https://nextjs.org/docs/api-routes/introduction).
