...
- [electron-vue-next](https://github.com/ci010/electron-vue-next) - Starter template using Vue 3 in vite and latest Electron with fluent vscode debug and github release process out-of-box.
