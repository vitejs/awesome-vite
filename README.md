...
- [vite-plugin-dev-manifest](https://github.com/owlsdepartment/vite-plugin-dev-manifest) - generates `manifest.dev.json` during Vite dev server, for backend integration with any language/framework
