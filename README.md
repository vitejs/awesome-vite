...
- [vite-electron-builder](https://github.com/cawa-93/vite-electron-builder/) - GitHub template for Electron apps. Using Vue 3, Vite and electron-builder with auto updates. 
