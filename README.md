...
- [vite-plugin-svg-path-hot](https://github.com/williamyorkl/vite-plugin-svg-path-hot) - Support Dynamic Created Svg Folder And Hot update based on `vite-plugin-svg-icons`.
