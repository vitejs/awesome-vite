...
- [vite-element-plus-admin](https://github.com/asasugar/vite-element-plus-admin) - Admin starter template based on `Vite` + `Vue3` + `TypeScript` + `Vue-Router4` + `Pinia` + `Axios` + `Element Plus`.
#### Vue 2
