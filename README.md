...
- [vite-electron-builder](https://github.com/cawa-93/vite-electron-builder/) - GitHub template for Electron apps. Used Vite for frontend and backend. Used electron-builder with auto-release and auto-updates for distribution.
