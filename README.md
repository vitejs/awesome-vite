...
- [@responsive-image/vite-plugin](https://github.com/simonihmig/responsive-image) - Transform and generate optimized images (WebP, AVIF) and LQIP placeholders for use with image components of the [ResponsiveImage](https://responsive-image.dev/) project.
